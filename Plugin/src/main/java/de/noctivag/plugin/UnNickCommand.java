...
public class UnNickCommand implements CommandExecutor {
    ...
    public UnNickCommand(PlayerDataManager playerDataManager, NametagManager nametagManager, MessageManager messageManager) {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        playerDataManager.removeNickname(player.getUniqueId().toString());
        playerDataManager.savePlayerData(); // SOFORT SPEICHERN
        nametagManager.updateNametag(player);
        player.sendMessage(messageManager.getMessage("nickname.removed"));
        return true;
    }
}
